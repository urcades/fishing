//! Fishing protocol draft 0.1: pure fixed-step functions, JSON wire types,
//! bounded geometry and explicit seeded randomness. See spec/PROTOCOL.md.
pub mod dynamics;
pub mod geometry;
pub mod loadout;
pub mod types;
pub use dynamics::{create_state, observe, random, step};
pub use loadout::{resolve, select, Bait, Definition, Encounter, Fish, Loadout, Rod};
